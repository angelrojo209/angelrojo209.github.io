...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-06-2024 a las 04:35:25
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `spotify` FOREIGN KEY (`membresias_id`) REFERENCES `membresias` (`id`);
COMMIT;
